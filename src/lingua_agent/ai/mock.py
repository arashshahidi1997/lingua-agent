...
_FAKE_DICT: dict[str, dict[str, str]] = {
    "coffee":     {"it": "caffè",       "fa": "قهوه",     "ru": "кофе",       "de": "Kaffee",      "nl": "koffie"},
    "water":      {"it": "acqua",       "fa": "آب",       "ru": "вода",       "de": "Wasser",      "nl": "water"},
    "glass":      {"it": "bicchiere",   "fa": "لیوان",    "ru": "стакан",     "de": "Glas",        "nl": "glas"},
    "train":      {"it": "treno",       "fa": "قطار",     "ru": "поезд",      "de": "Zug",         "nl": "trein"},
    "station":    {"it": "stazione",    "fa": "ایستگاه",  "ru": "станция",    "de": "Bahnhof",     "nl": "station"},
    "friend":     {"it": "amico",       "fa": "دوست",     "ru": "друг",       "de": "Freund",      "nl": "vriend"},
    "university": {"it": "università",  "fa": "دانشگاه",  "ru": "университет","de": "Universität", "nl": "universiteit"},
    "biology":    {"it": "biologia",    "fa": "زیست‌شناسی","ru": "биология",   "de": "Biologie",    "nl": "biologie"},
    "today":      {"it": "oggi",        "fa": "امروز",    "ru": "сегодня",    "de": "heute",       "nl": "vandaag"},
    "yesterday":  {"it": "ieri",        "fa": "دیروز",    "ru": "вчера",      "de": "gestern",     "nl": "gisteren"},
    "book":       {"it": "libro",       "fa": "کتاب",     "ru": "книга",      "de": "Buch",        "nl": "boek"},
    "letter":     {"it": "lettera",     "fa": "نامه",     "ru": "письмо",     "de": "Brief",       "nl": "brief"},
    "read":       {"it": "leggere",     "fa": "خواندن",    "ru": "читать",     "de": "lesen",       "nl": "lezen"},
    "write":      {"it": "scrivere",    "fa": "نوشتن",     "ru": "писать",     "de": "schreiben",   "nl": "schrijven"},
    "the":        {"it": "il",          "fa": "",         "ru": "",           "de": "der",         "nl": "de"},
    "a":          {"it": "un",          "fa": "یک",       "ru": "",           "de": "ein",         "nl": "een"},
    "and":        {"it": "e",           "fa": "و",        "ru": "и",          "de": "und",         "nl": "en"},
    "of":         {"it": "di",          "fa": "از",       "ru": "",           "de": "von",         "nl": "van"},
    "is":         {"it": "è",           "fa": "است",      "ru": "",           "de": "ist",         "nl": "is"},
    "i":          {"it": "io",          "fa": "من",       "ru": "я",          "de": "ich",         "nl": "ik"},
    "you":        {"it": "tu",          "fa": "تو",       "ru": "ты",         "de": "du",          "nl": "jij"},
    "she":        {"it": "lei",         "fa": "او",       "ru": "она",        "de": "sie",         "nl": "zij"},
    "he":         {"it": "lui",         "fa": "او",       "ru": "он",         "de": "er",          "nl": "hij"},
    "would":      {"it": "vorrei",      "fa": "می‌خواهم",  "ru": "хотел бы",   "de": "möchte",      "nl": "zou willen"},
    "like":       {"it": "vorrei",      "fa": "می‌خواهم",  "ru": "хотел бы",   "de": "möchte",      "nl": "zou willen"},
    "where":      {"it": "dove",        "fa": "کجا",      "ru": "где",        "de": "wo",          "nl": "waar"},
    "study":      {"it": "studia",      "fa": "می‌خواند",  "ru": "изучает",    "de": "studiert",    "nl": "studeert"},
    "going":      {"it": "va",          "fa": "می‌رود",   "ru": "идёт",       "de": "geht",        "nl": "gaat"},
}
...
class MockProvider:
    ...
    def _grammar_draft(self, text: str, *, target_language: str) -> dict[str, Any]:
        ...
        if target_language == "it":
            ...
            point = {"name": "V2 word order",
                     "summary": "The finite verb is the second constituent in main clauses.",
                     "evidence": evidence,
                     "confidence": "medium"}
        elif target_language == "nl":
            point = {"name": "V2 word order + de/het gender",
                     "summary": "Common-gender 'de' vs neuter 'het'; finite verb second in main clauses.",
                     "evidence": evidence,
                     "confidence": "medium"}
        else:
